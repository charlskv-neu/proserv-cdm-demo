...
1. [Download the starter kit](https://github.com/charlskv-neu/proserv-cdm-demo/tree/feature/sqlpool) , and extract its contents to the location of your choice.
