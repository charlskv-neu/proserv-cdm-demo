...
BEGIN
	...
	IF NOT EXISTS (SELECT top 1 1 FROM sys.external_data_sources WHERE NAME='demoGLExtDS')
	BEGIN
		DECLARE @CreateExtDS NVARCHAR(4000) = N'CREATE EXTERNAL DATA SOURCE demoGLExtDS
		WITH (
